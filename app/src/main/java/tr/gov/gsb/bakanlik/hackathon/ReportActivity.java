...
public class ReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ReportPostClass(useremailFromFB, usercommentFromFB, usercodecommentFromFB, userimageFromFB, userPlaceFB, userVolunNumberFB, this);
    ...
    public void getDataFromFirebase() {
        ...
        DatabaseReference newReference = firebaseDatabase.getReference("Reports");
