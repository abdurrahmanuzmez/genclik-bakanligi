...
public class ReportPostClass extends ArrayAdapter<String> {
    ...
    public ReportPostClass(ArrayList<String> userEmail, ArrayList<String> userComment, ArrayList<String> userCodeComment, ArrayList<String> userImage,ArrayList<String> userPlace,ArrayList<String> userVolunNumber, Activity context) {
        super(context,R.layout.report_custom,userEmail);
