...
public class FavoritesPostClass extends ArrayAdapter<String> {
    ...
    public FavoritesPostClass(ArrayList<String> userEmail, ArrayList<String> userComment, ArrayList<String> userCodeComment, ArrayList<String> userImage, ArrayList<String> userPlace, ArrayList<String> userVolunNumber, Activity context) {
